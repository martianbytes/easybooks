...
class Profile(models.Model):
    ...
    seller_rating = models.DecimalField(max_digits=3, decimal_places=2, default=Decimal('0.0'), validators=[MinValueValidator(0)])
...
class SellerReview(models.Model):
    ...
    def __str__(self):
        return f"{self.reviewer.username} → {self.seller.user.username} ({self.rating}★)"